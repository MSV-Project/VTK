/*=========================================================================
  ...
  Module:    TestBalloonWidgetPicking.cxx
...
// Press "Space" to reorganize the cube
...
public:
  ...
  virtual void Execute(vtkObject *caller, unsigned long, void*)
    ...
    // Reorganize the cube
    else if (vtkStdString(iren->GetKeySym()) == "space")
      {
      std::cout << "reorganization Pressed" << std::endl;
      }
    }
...
public:
  ...
  {
    this->performanceReport.open("/home/michael/pickingManagerPerfs.txt");
  ...
  virtual void Execute(vtkObject *caller, unsigned long, void*)
  {
    ...
    if (this->performanceReport.is_open())
      {
      // FPS Measurement
      /*this->performanceReport << "; " << iren->GetRenderWindow()->GetRenderers()->
...
//------------------------------------------------------------------------------
// Test Picking Manager with a bunch of seeds
//------------------------------------------------------------------------------
int TestPickingManagerSeedWidget( int argc, char *argv[] )
{
  ...
  /*recorder->SetFileName("/home/michael/pickingManagerSeeds.log");
