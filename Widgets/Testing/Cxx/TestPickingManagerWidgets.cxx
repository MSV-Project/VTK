...
=========================================================================*/
//
// This example tests the PickingManager using different widgets:
// - vtkBalloonWidget
// - vtkBoxWidget
...
// Press "ALT" to enable/disable the Optimization on render events.
...
//------------------------------------------------------------------------------
// Test Picking Manager with a bunch of widgets
//------------------------------------------------------------------------------
int TestPickingManagerWidgets( int argc, char *argv[] )
{
  ...
  glyph->SetSource(cone1->GetOutput());
  ...
  apdImpPlane->AddInput(glyphImpPlane->GetOutput());
  apdImpPlane->AddInput(sphereImpPlane->GetOutput());
